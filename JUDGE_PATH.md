# JUDGE_PATH (fill before scaffolding)

Contest: Brainwave 2026 Midnight Track (challenge 30979)  
Family: Devpost

## Gate A — listing

- Official URL: https://brainwave-2026-midnight-track.devpost.com/
- Rules URL: https://brainwave-2026-midnight-track.devpost.com/rules
- Dates (submission close, judging, winners) — copied from **rules**, not the hero:
  - Official Rules page lists **requirements** (Preview/PreProd deploy, full-stack, Midnight) and does **not** print a close clock.
  - Live **schedule widget** (`/details/dates`, Chrome 2026-08-21): Submissions August 10 at 11:00AM PDT – **August 26 at 6:30PM PDT**; Judging August 26 at 8:30PM PDT – August 28 at 3:00AM PDT; Winners Announced August 28 at 7:30AM PDT.
- Prize module agrees with hero cash? yes — homepage Winner $100 + $200 swag, 1st runner $70+$150, 2nd $50+$100; manage hero shows **$220 in cash** (100+70+50). Rules page does not list dollars (requirements-only, not a contradictory figure).
- Eligibility: international; developers, students, researchers, designers, enthusiasts. Teams must use Midnight meaningfully and **deploy Compact on Preview or PreProd**. This machine has no Docker proof-server; pack stays honest (no invented contract address).
- Kill listing? no
...
Non-chat UI? yes — photon-ring instrument + public ledger panel
